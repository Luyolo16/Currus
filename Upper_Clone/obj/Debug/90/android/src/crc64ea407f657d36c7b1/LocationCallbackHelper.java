...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Upper_Clone.Helpers.LocationCallbackHelper, Upper_Clone", LocationCallbackHelper.class, __md_methods);
	}
	...
	public LocationCallbackHelper ()
	{
		...
		if (getClass () == LocationCallbackHelper.class)
			mono.android.TypeManager.Activate ("Upper_Clone.Helpers.LocationCallbackHelper, Upper_Clone", "", this, new java.lang.Object[] {  });
	}
